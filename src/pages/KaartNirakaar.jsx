...
/* ─── Design tokens (Kaart dark green palette) ────────────────────────────── */
const K = {
  bg:       '#060e09',
  surface:  '#0a1510',
  card:     '#0d1c14',
      ...
      <div className="container" style={{ position: 'relative' }}>
        ...
        <div className="grid" style={{ gap: 'var(--gap)', alignItems: 'end' }}>
          <div className="col-8">
            ...
            <h1 className="serif" style={{ fontSize: 'clamp(40px, 6vw, 80px)', lineHeight: 1.02, letterSpacing: '-0.02em', color: K.cream }}>
              Nirakaar.<br />
          ...
          <div className="col-4">
            <p className="body" style={{ color: K.muted, maxWidth: '34ch', lineHeight: 1.7, marginBottom: 24 }}>
    ...
    <section style={{ background: K.surface, color: K.cream, padding: 'clamp(60px, 9vw, 120px) 0', borderTop: `1px solid ${K.border}` }}>
      <div className="container">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', borderTop: `1px solid ${K.border}` }}>
          {SERVICES.map((s, i) => (
            <div key={s.n} className="reveal" style={{ '--i': i, display: 'grid', gridTemplateColumns: '48px 1fr 1fr', gap: 'clamp(20px, 3vw, 40px)', padding: 'clamp(28px, 3vw, 40px) 0', borderBottom: `1px solid ${K.border}`, alignItems: 'start' }}>
              {/* Icon */}
              <div style={{ fontFamily: 'var(--mono)', fontSize: 20, color: K.green, paddingTop: 2 }}>{s.icon}</div>
              {/* Title + pills */}
              <div>
              ...
              {/* Body */}
              <p className="body" style={{ color: K.muted, lineHeight: 1.7, paddingTop: 36 }}>{s.body}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="container" style={{ position: 'relative' }}>
        <div className="grid" style={{ gap: 'var(--gap)', alignItems: 'center' }}>
          <div className="col-7">
            ...
            <h2 className="serif" style={{ fontSize: 'clamp(32px, 5vw, 64px)', lineHeight: 1.05, letterSpacing: '-0.02em', color: '#fff' }}>
          ...
          <div className="col-5" style={{ display: 'flex', flexDirection: 'column', gap: 16, alignItems: 'flex-start' }}>
            ...
            <Link to="/contact"
              style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: '#fff', color: K.green, border: 'none', borderRadius: 6, padding: '14px 24px', fontFamily: 'var(--sans)', fontSize: 15, fontWeight: 600, textDecoration: 'none', cursor: 'pointer' }}>
              Brief us →
            </Link>
            <Link to="/kaart"
