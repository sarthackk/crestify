...
const PROJECTS = [
  ...
  { n: '05', col: 'col-7', dark: true,  client: 'Mockzy',          sector: 'AI Product',              headline: 'A smartphone photo in. Ad-grade product imagery out — no prompts, no designer.',                        metric: 'Live · Paying users', tag: 'AI · SaaS',          slug: 'mockzy',                 ratio: '7 / 5', img: '/mockzy.png' },
...
const BRAND_WALL_LOGOS = [
  'quickhunt.png', 'giva.png', 'veda-jewel.png', 'james-aston.png', 'upride.svg', 'haldirams.webp', 'commontime.jpg', 'nirakaar.svg', 'cafoco-logo-purple-on-transparent.png', 'dotty.png',
